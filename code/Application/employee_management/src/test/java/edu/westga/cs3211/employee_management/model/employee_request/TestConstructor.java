...
public class TestConstructor {
	...
	void testNullType() {
		// ASSIGN
		EmployeeProfile profile = new EmployeeProfile(1234, "john", "d", "smith", "email", "phone", true, "username",
				"password");
	...
	void testValidEmployeeRequest() {
		...
		// ASSERT
		assertAll(() -> assertEquals(profile, request.getEmployee()), () -> assertEquals("Vacation", request.getType()),
				...
				() -> assertEquals("Employee: john smith :: " + "Request Type: " + request.getType() + " Dates: "
